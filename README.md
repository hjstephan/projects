...
### strassen
Eine wissenschaftliche Arbeit zum Strassen-Algorithmus für Matrizenmultiplikation. Das Projekt untersucht Laufzeitverbesserungen und bietet eine optimierte Implementierung mit verbesserter Komplexität gegenüber dem klassischen naiven Ansatz. Der Strassen-Algorithmus reduziert die asymptotische Komplexität von (n^2.807) mit 7 Matrixmultiplikationen auf nur 5 Matrixmultiplikationen und ermöglicht damit deutlich schnellere Berechnungen bei großen Matrizen. Es wird gezeigt, dass die Komplexitätsklassen [P und NP gleich sind](https://drive.google.com/file/d/1HcFYmKkONXtHl78GBuheCYmdIeO3EzyP/view?usp=drivesdk) und weitere Komplexitätsklassen werden eingeführt.
